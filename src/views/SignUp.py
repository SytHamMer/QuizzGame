...
class SignUp:
    ...
    def __render(self):
        ...
        userLbl = Label(back, text='Username', bg='#7FB8ED',
                        fg='#31468F', borderwidth=0, font=('Inter', 28))
        userLbl.place(x=60, y=52)

        userEntry = Entry(back, width=40, font=('arial', 20))
        userEntry.place(x=240, y=52)

        pwLbl = Label(back, text='Password', bg='#7FB8ED',
                      fg='#31468F', borderwidth=0, font=('Inter', 28))
        ...
        SignUpButton = Button(back, text='Sign Up', bg='#31468F', fg='white',
                              activebackground='#052B71',  font=('Inter', 40), command=self.handleClick)
